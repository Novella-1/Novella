  ...
  return (
    <motion.div
      ...
      className={
        ...
        : 'absolute top-full left-1/2 mt-4 bg-custom-secondary rounded-xl z-50 p-6 max-h-[290px] overflow-y-auto custom-scrollbar shadow-lg w-[480px] -translate-x-1/2'
      }
    >
      {[...Array(count)].map((_, i) => (
        <div
