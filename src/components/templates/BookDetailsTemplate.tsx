...
export async function BookDetailsTemplate({
  ...
  const bookWithDetails = await getBookBySlug('iron-flame-uk-hardcover');
    ...
    <div className={cn(className)}>
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-col sm:gap-[34px] xl:flex-row xl:gap-[88px] xl:h-[524px] xl:items-start">
          ...
          <BookInfo
            ...
            coverType={bookWithDetails?.coverType}
            numberOfPages={bookWithDetails?.numberOfPages}
      ...
      <div className="flex flex-col xl:flex-row gap-10 xl:gap-[88px] mb-20">
        ...
        <BookCharacteristics
          ...
          format={bookWithDetails?.format}
          lang={bookWithDetails?.lang}
          illustrations={bookWithDetails?.illustrations}
        />
      </div>
    </div>
  );
